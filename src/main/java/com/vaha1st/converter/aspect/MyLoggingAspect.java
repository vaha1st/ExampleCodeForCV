package com.vaha1st.converter.aspect;
...
public class MyLoggingAspect {
    ...
    @Pointcut("execution(* com.vaha1st.converter.controllers.*.*(..))")
    private void forController() {
    }

    @Pointcut("execution(* com.vaha1st.converter.service.*.*(..))")
    private void forService() {
    }

    @Pointcut("execution(* com.vaha1st.converter.dao.*.*(..))")
    private void forDao() {
    }
